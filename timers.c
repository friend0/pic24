...
/**
 * @Function SetTimer(unsigned char Num, unsigned int NewTime)
...
/**
 * @Function StartTimer(unsigned char Num)
...
/**
 * @Function StopTimer(unsigned char Num)
...
/**
 * @Function InitTimer(unsigned char Num, unsigned int NewTime)
 * @param Num -  the number of the timer to start
...
/**
 * @Function ClearTimerExpired(unsigned char Num) 
...
void __ISR(_TIMER_5_VECTOR, ipl3) Timer5IntHandler(void) {
    INTClearFlag(INT_T5);
    FreeRunningTimer++;
    char CurTimer = 0;
